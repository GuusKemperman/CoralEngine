...
void Engine::RenderToCamerasSystem::Render(const World& world)
{
	...
	ASSERT_LOG_TRIVIAL(optionalEntityCameraPair.has_value(), "XSR draw requests have been made, but they cannot be cleared as there is no camera to draw them to");
