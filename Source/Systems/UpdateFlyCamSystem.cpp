...
void CE::UpdateFlyCamSystem::Update(World& world, float dt)
{
	...
	movementInput[Axis::Right] = input.GetKeyboardAxis(Input::KeyboardKey::D, Input::KeyboardKey::A) * isMouseButtonHeld;
	...
	const glm::vec2 timeScaledRotationInput = mouseInput * flyCam->mRotationSpeed;
