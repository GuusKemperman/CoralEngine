...
private:
    ...
    enum {
        ...
        kNullFlag = kNullType,
        kTrueFlag = kTrueType | 0x0008,
        kFalseFlag = kFalseType | 0x0008,
        kNumberIntFlag = kNumberType | 0x0010 | 0x0020 | 0x0080,
        kNumberUintFlag = kNumberType | 0x0010 | 0x0040 | 0x0100 | 0x0080,
        kNumberInt64Flag = kNumberType | 0x0010 | 0x0080,
        kNumberUint64Flag = kNumberType | 0x0010 | 0x0100,
        kNumberDoubleFlag = kNumberType | 0x0010 | 0x0200,
        kNumberAnyFlag = kNumberType | 0x0010 | 0x0020 | 0x0080 | 0x0040 | 0x0100 | 0x0200,
        kConstStringFlag = kStringType | 0x0400,
        kCopyStringFlag = kStringType | 0x0400 | 0x0800,
        kShortStringFlag = kStringType | 0x0400 | 0x0800 | 0x1000,
