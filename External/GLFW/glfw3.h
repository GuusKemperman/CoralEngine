 ...
 *  monitor.  The returned array is sorted in a***REMOVED***nding order, first by color
...
/*! @brief Set the motor speed of a specific controller
*
*
*
*
*/
GLFWAPI void glfwSetJoystickRumble(int jid, unsigned short LeftMotorSpeed, unsigned short RightMotorSpeed);
