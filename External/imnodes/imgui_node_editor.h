...
using ConfigSaveSettings     = bool   (*)(const char* data, size_t size, SaveReasonFlags reason, void* userPointer1, void* userPointer2);
using ConfigLoadSettings     = size_t (*)(char* data, void* userPointer1, void* userPointer2);

using ConfigSaveNodeSettings = bool   (*)(NodeId nodeId, const char* data, size_t size, SaveReasonFlags reason, void* userPointer1, void* userPointer2);
using ConfigLoadNodeSettings = size_t (*)(NodeId nodeId, char* data, void* userPointer1, void* userPointer2);

using ConfigSession          = void   (*)(void* userPointer1, void* userPointer2);
...
struct Config
{
    ...
    Config()
        ...
        , UserPointer1(nullptr)
        , UserPointer2(nullptr)
        , CustomZoomLevels()
...
IMGUI_NODE_EDITOR_API const ImRect& GetCanvasRect();
