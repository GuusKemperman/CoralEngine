...
static void StackLayout_NewFramePreCallback(ImGuiContext*, ImGuiContextHook* hook)
{
...
static void StackLayout_EndFramePreCallback(ImGuiContext*, ImGuiContextHook* hook)
{
    ImGuiLayoutState* layout_state = (ImGuiLayoutState*)hook->UserData;
...
static void StackLayout_ShutdownCallback(ImGuiContext*, ImGuiContextHook* hook)
{
    ImGuiLayoutState* layout_state = (ImGuiLayoutState*)hook->UserData;
