...
namespace Engine
{
	...
	private:
		...
		static void PrintCollisionData(entt::entity entity, PhysicsBody2DComponent& body);
		...
		static bool CollisionCheckDiskPolygon(const glm::vec2& diskCenter, float diskRadius, const glm::vec2& polygonPos, const std::vector<glm::vec2>& polygonPoints, CollisionData& result);
		...
		static glm::vec2 GetNearestPointOnLineSegment(const glm::vec2& p, const glm::vec2& segmentA, const glm::vec2& segmentB);
