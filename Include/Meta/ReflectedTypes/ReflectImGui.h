...
template<>
struct Reflector<ImGuiKey>
{
	static Engine::MetaType Reflect();
}; REFLECT_AT_START_UP(ImGuiKey);

template<>
struct Engine::EnumStringPairsImpl<ImGuiKey>
{
	static constexpr EnumStringPairs<ImGuiKey, 137> value = {
		EnumStringPair<ImGuiKey>{ ImGuiKey_None, "None" },
		{ ImGuiKey_Tab, "Tab" },
