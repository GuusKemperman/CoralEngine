...
float4 main(VS_OUTPUT input) : SV_TARGET
{
    ...
    else
    {
        ...
        float4 diffAndSpec = float4(diffuse + specular, mat.baseColor.a);
        result = diffAndSpec * colorMul;
...
PBRMaterial GenerateMaterial(VS_OUTPUT input)
{
    ...
    mat.diffuse.rgb = lerp(mat.baseColor.rgb, float3(0.0, 0.0, 0.0), mat.metallic);
    mat.diffuse.a = mat.baseColor.a;
    ...
    inout float3 specular)
{
    ...
    float3 diffuseBRDF = LambertianDiffuse(mat.diffuse.rgb, mat.F0, float3(1.0, 1.0, 1.0), vDotH);
